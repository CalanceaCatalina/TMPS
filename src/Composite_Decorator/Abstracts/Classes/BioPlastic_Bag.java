...
public class BioPlastic_Bag extends Boxes { //concrete decorator//composite

    private List<Boxes> child = new ArrayList<>();

    public BioPlastic_Bag(IBoxes box) {
        super(box);
    }
    ...
    public String Display() {
        String name ="BioPlastic Bag";
        System.out.println(name);
        child.forEach(Boxes::Display);
        return name;
    }
    public void addBag(Boxes bag) { child.add(bag); }
